...
class NotificationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendWelcomeEmail = channel.unary_unary(
                '/notification.NotificationService/SendWelcomeEmail',
                request_serializer=notification__pb2.EmailRequest.SerializeToString,
                response_deserializer=notification__pb2.EmailResponse.FromString,
...
def add_NotificationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendWelcomeEmail': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=notification__pb2.EmailRequest.FromString,
                    response_serializer=notification__pb2.EmailResponse.SerializeToString,
            ),
    }
...
class NotificationService(object):
    ...
    def SendWelcomeEmail(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/notification.NotificationService/SendWelcomeEmail',
            notification__pb2.EmailRequest.SerializeToString,
            notification__pb2.EmailResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
